...
import { TypingBro } from '@pages/home/components/intro/typing-bro/typing-bro'
@Component({
  selector: 'intro',
  template: `
    <section class="mt-8 relative">
      <div class="grid grid-cols-1">
        <div
          class="w-full sm:w-auto flex flex-col gap-3 justify-between sm:absolute top-0 left-0 sm:top-5 bg-gray-400 rounded-md bg-clip-padding backdrop-filter bg-opacity-10 border border-gray-400/50 p-5">
        ...
        <div>
          <typing-bro class="flex justify-end"/>
        </div>
      </div>
    </section>
  `,
  imports: [SocialLink, Button, TypingBro, Icon],
